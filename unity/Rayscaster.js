...
var offsetPos : Vector3 = Vector3(0,0,0);
var extraPos : Vector3 = Vector3(0,0,0);
...
function changeCol(values : Array) {
	this.listOfCol = {};
	this.listOfCol[values[0]] = values[1];
}
...
function Update () {	
	Debug.DrawRay(gameObject.transform.position+fish, pish * 2, Color.green);
//	
//	previousPositions.Add(gameObject.transform.position - previous);		
...
//	var number = 0;
//	var currentCol = "";	
//	for(var each in this.listOfCol) {		
//		if(each.Value) {
//			number++;
//			currentCol = each.Key;
//		}
